...
use Exporter;
our @ISA = 'Exporter';
our @EXPORT = qw($cLApPrimaryControllerAddress $cLApSecondaryControllerAddress $bsnAPLocation $bsnAPReset $cLApIfMacAddress $bsnAPGroupVlanName $bsnAPGroupsVlanName
